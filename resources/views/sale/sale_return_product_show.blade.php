                    ...
                    <div class="card-body">
                        ...
                        <div class="purchase_details">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <p>Biller: </p>
                                    <p><strong>{{$return_product->user?$return_product->user->name:''}}</strong></p>
                                    <p>018791302599</p>
                                    <p>aws@gmail.com</p>
                                    <p>Linking Street
                                ...
                                <div class="col-md-4">
                                    <p>Customer Info:</p>
                                    <p>
                                        <strong>{{$return_product->customer->name?$return_product->customer->name:''}}</strong>
                                    </p>
                                    <p>{{$return_product->customer->email?$return_product->customer->email:''}}</p>
                                    <p>{{$return_product->customer->phone?$return_product->customer->phone:''}}</p>
                                    <p>{{$return_product->customer->address?$return_product->customer->address:''}}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered"
                            ...
                            $grandTotal = 0;
                            @endphp
                            @if(isset($return_product->productSaleReturns))
                                @foreach($return_product->productSaleReturns as $index=>$item)
                                    <tr>
                                        <td>{{++$index}}</td>
